...
class Vender:
    def __init__(self, graphic: Camera) -> None:
        ...
        self.stock = {"冷氣卡": [1,2], "餅乾": [3,4]}
        self.clerk = Clerk.Clerk(self.graphic, self.products, self.stock)
        self.cashier = Cashier.Cashier(self.products)
    ...
    def run(self) -> None:
        while 1:
            ...
            try:
                ...
                self.cashier.checkout(info.cart)
